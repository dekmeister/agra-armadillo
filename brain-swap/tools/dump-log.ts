...
const levels: Record<string, LevelEntry> = {
  ...
  "21": { level: L.level21, ref: L.level21ReferenceBrain, naive: L.level21NaiveBrain },
  "22": { level: L.level22, ref: L.level22ReferenceBrain, naive: L.level22NaiveBrain },
  "23": { level: L.level23, ref: L.level23ReferenceBrain, naive: L.level23NaiveBrain },
  "24": { level: L.level24, ref: L.level24ReferenceBrain, naive: L.level24NaiveBrain },
  "31": { level: L.level31, ref: L.level31ReferenceBrain, naive: L.level31NaiveBrain },
  "32": { level: L.level32, ref: L.level32ReferenceBrain, naive: L.level32NaiveBrain },
  "33": { level: L.level33, ref: L.level33ReferenceBrain, naive: L.level33NaiveBrain },
  "34": { level: L.level34, ref: L.level34ReferenceBrain, naive: L.level34NaiveBrain },
  "35": { level: L.level35, ref: L.level35ReferenceBrain, naive: L.level35NaiveBrain },
