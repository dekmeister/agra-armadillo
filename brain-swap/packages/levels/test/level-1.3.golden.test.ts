...
const GOLDEN_LOG = [
  ...
  "t6 FA->MA NavigationReportMT [delivered]",
  ...
  "t11 FA->MA NavigationReportMT [delivered]",
  ...
  "t16 FA->MA NavigationReportMT [delivered]",
  ...
  "t21 FA->MA NavigationReportMT [delivered]",
  ...
  "t26 FA->MA NavigationReportMT [delivered]",
