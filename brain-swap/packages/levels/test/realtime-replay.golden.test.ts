...
import {
  ...
  level21,
  level21ReferenceBrain,
  level22,
  level22ReferenceBrain,
  level23,
  level23ReferenceBrain,
  level24,
  level24ReferenceBrain,
  level31,
  level31ReferenceBrain,
  level32,
  level32ReferenceBrain,
  level33,
  level33ReferenceBrain,
  level34,
  level34ReferenceBrain,
  level35,
  level35ReferenceBrain,
  level42,
...
const CASES: Case[] = [
  ...
  { id: "2.1", level: level21, brain: level21ReferenceBrain },
  { id: "2.3", level: level23, brain: level23ReferenceBrain },
  { id: "2.4", level: level24, brain: level24ReferenceBrain },
  { id: "2.2", level: level22, brain: level22ReferenceBrain },
  { id: "3.1", level: level31, brain: level31ReferenceBrain },
  { id: "3.2", level: level32, brain: level32ReferenceBrain },
  { id: "3.3", level: level33, brain: level33ReferenceBrain },
  { id: "3.4", level: level34, brain: level34ReferenceBrain },
  { id: "3.5", level: level35, brain: level35ReferenceBrain },
